var commands = [
  ...
  { left: "local_repo", right: "local_repo", direction: "status",
    cmd: "sh/show <commit>",
    docs: "Shows the contents of the given commit. by default HEAD." +
          "Use -deep to see a diff" },
  ...
  { left: "workspace", right: "local_repo", direction: "dn",
    ...
    docs: "Reverse specified <commit> and commits the result. " +
  ...
  { left: "local_repo", right: "local_repo", direction: "status",
    cmd: "lg/log",
    docs: 'By default, shows a graph of your recent commits/merges. With a parametr, show recent commits,'+
		 ' most recent on top. Options:' +
  ...
  { left: "local_repo", right: "remote_repo", direction: "status",
    cmd: "br/branch",
